    ...
    const groupedCities = ref([
      {
        ...
        code: "DNR",
        items: [
          { label: "Донецк", value: "Donetsk" },
          { label: "Мариуполь", value: "Mariupol" },
          { label: "Волноваха", value: "Volnovakha" },
          { label: "Горловка", value: "Gorlovka" },
          { label: "Макеевка", value: "Makeevka" },
        ],
      },
      {
        label: "ЛНР",
        code: "LNR",
        items: [
          { label: "Луганск", value: "Lugansk" },
          { label: "Лисичанск", value: "Lisichansk" },
          { label: "Северодонецк", value: "Severodonetsk" },
          { label: "Алчевск", value: "Alchevsk" },
          { label: "Сватово", value: "Svatovo" },
        ],
      },
      {
        label: "Запорожская обл.",
        code: "ZPR",
        items: [
          { label: "Мелитополь", value: "Melitopol" },
          { label: "Энергодар", value: "Energodar" },
          { label: "Бердянск", value: "Berdyansk" },
          { label: "Михайловка", value: "Mikhailovka" },
          { label: "Пологи", value: "Pologi" },
          { label: "Токмак", value: "Tokmak" },
        ],
      },
      {
        label: "Херсонская обл.",
        code: "HRSN",
        items: [
          { label: "Херсон", value: "Herson" },
          { label: "Новая Каховка", value: "NovayaKakhovka" },
          { label: "Каланчак", value: "Kalanchak" },
          { label: "Еничевск", value: "Enichevsk" },
          { label: "Скадовск", value: "Skadowsk" },
        ],
      },
    ]);
